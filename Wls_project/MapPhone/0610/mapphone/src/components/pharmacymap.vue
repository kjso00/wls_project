        ...
        <div class="total">
            <header class="navigation">
                <div class="first">
                    ...
                    <div class="gps">
                        <div class="gpslocation">{{ currentLocation }}</div> <!-- 위치 표시 -->
                        <div>
...
const keyword = ref(''); // 검색어를 저장할 변수
const places = ref([]); // 장소 목록을 저장할 변수
let mapInstance; // 지도 인스턴스를 저장할 변수
const ps = ref(null); // 장소 검색 서비스를 저장할 변수
const boundsChangedListener = ref(null); // 지도 경계 변경 이벤트 리스너를 저장할 변수
const selectedPlace = ref(null); // 선택된 장소 정보를 저장할 변수
const showPopup = ref(false); // 팝업창 상태를 저장할 변수
